// Acceder a HttpAgent y Actor desde el ámbito global expuesto por el CDN
...
// Configurar el canister (reemplazado con tu ID real)
const canisterId = "uxrrr-q7777-77774-qaaaq-cai"; // ID real proporcionado
const agent = new HttpAgent({ host: "http://localhost:4943" }); // Usa localhost para pruebas locales
if (agent.isLocal()) {
  agent.fetchRootKey(); // Necesario para pruebas locales
}
...
// Editar y Eliminar (puedes implementarlos según necesites)
